CREATE TABLE [dbo].[Budget] (
    ...
    CONSTRAINT [FK_Budget_Account] FOREIGN KEY ([AccountId]) REFERENCES [dbo].[Account] ([Id]),
    ...
    CONSTRAINT [UQ_Budget_Department_Account_Date] UNIQUE NONCLUSTERED ([DepartmentId] ASC, [AccountId] ASC, [Year] ASC, [Month] ASC)
);
