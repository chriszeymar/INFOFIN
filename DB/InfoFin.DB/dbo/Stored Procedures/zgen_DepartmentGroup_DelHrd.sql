/****** Object:  StoredProcedure [dbo].[zgen_DepartmentGroup_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete DepartmentGroup
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_DepartmentGroup_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[DepartmentGroup] WHERE [Id]=@Id;
