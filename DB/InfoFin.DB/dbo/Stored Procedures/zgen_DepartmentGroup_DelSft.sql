/****** Object:  StoredProcedure [dbo].[zgen_DepartmentGroup_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete DepartmentGroup
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_DepartmentGroup_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[DepartmentGroup] SET IsActive = 0 WHERE [Id]=@Id;
