/****** Object:  StoredProcedure [dbo].[zgen_Actuals_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete Actuals
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_Actuals_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[Actuals] WHERE [Id]=@Id;
