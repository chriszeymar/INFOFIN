/****** Object:  StoredProcedure [dbo].[zgen_BucketType_InsUpd] ******/
-- ===================================================================
-- Description    : Insert Update BucketType
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_BucketType_InsUpd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    IF @Id IS NULL
    BEGIN
      INSERT INTO [dbo].[BucketType]
        ([Name],[IsActive])
      VALUES
        (@Name,@IsActive);
      SELECT * FROM [dbo].[BucketType] WHERE [Id] = SCOPE_IDENTITY();
    END
  ELSE
    BEGIN
      UPDATE [dbo].[BucketType]
