/****** Object:  StoredProcedure [dbo].[zgen_BucketType_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete BucketType
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_BucketType_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[BucketType] SET IsActive = 0 WHERE [Id]=@Id;
