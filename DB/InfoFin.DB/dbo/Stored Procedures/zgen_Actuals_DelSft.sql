/****** Object:  StoredProcedure [dbo].[zgen_Actuals_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete Actuals
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_Actuals_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[Actuals] SET IsActive = 0 WHERE [Id]=@Id;
