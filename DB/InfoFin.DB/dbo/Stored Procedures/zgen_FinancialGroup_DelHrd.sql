/****** Object:  StoredProcedure [dbo].[zgen_FinancialGroup_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete FinancialGroup
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_FinancialGroup_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[FinancialGroup] WHERE [Id]=@Id;
