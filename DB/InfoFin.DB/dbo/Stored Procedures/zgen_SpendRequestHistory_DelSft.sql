/****** Object:  StoredProcedure [dbo].[zgen_SpendRequestHistory_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete SpendRequestHistory
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_SpendRequestHistory_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[SpendRequestHistory] SET IsActive = 0 WHERE [Id]=@Id;
