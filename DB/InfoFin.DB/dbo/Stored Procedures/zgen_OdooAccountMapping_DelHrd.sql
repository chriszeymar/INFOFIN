/****** Object:  StoredProcedure [dbo].[zgen_OdooAccountMapping_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete OdooAccountMapping
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_OdooAccountMapping_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[OdooAccountMapping] WHERE [Id]=@Id;
