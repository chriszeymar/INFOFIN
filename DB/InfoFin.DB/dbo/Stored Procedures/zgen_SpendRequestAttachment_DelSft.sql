/****** Object:  StoredProcedure [dbo].[zgen_SpendRequestAttachment_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete SpendRequestAttachment
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_SpendRequestAttachment_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[SpendRequestAttachment] SET IsActive = 0 WHERE [Id]=@Id;
