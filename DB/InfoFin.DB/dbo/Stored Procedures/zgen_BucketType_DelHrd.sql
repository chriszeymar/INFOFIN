/****** Object:  StoredProcedure [dbo].[zgen_BucketType_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete BucketType
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_BucketType_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[BucketType] WHERE [Id]=@Id;
