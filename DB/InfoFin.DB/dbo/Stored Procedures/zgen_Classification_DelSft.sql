/****** Object:  StoredProcedure [dbo].[zgen_Classification_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete Classification
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_Classification_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[Classification] SET IsActive = 0 WHERE [Id]=@Id;
