/****** Object:  StoredProcedure [dbo].[zgen_OdooJournalLine_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete OdooJournalLine
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_OdooJournalLine_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[OdooJournalLine] WHERE [Id]=@Id;
