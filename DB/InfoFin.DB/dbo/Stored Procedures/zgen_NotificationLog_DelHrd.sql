/****** Object:  StoredProcedure [dbo].[zgen_NotificationLog_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete NotificationLog
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_NotificationLog_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[NotificationLog] WHERE [Id]=@Id;
