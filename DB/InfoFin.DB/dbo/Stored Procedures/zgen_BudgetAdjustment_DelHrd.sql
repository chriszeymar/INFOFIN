/****** Object:  StoredProcedure [dbo].[zgen_BudgetAdjustment_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete BudgetAdjustment
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_BudgetAdjustment_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[BudgetAdjustment] WHERE [Id]=@Id;
