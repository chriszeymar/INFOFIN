/****** Object:  StoredProcedure [dbo].[zgen_Classification_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete Classification
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_Classification_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[Classification] WHERE [Id]=@Id;
