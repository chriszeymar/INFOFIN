/****** Object:  StoredProcedure [dbo].[zgen_Currency_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete Currency
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_Currency_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[Currency] WHERE [Id]=@Id;
