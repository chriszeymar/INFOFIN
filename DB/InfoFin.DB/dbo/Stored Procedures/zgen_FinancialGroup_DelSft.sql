/****** Object:  StoredProcedure [dbo].[zgen_FinancialGroup_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete FinancialGroup
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_FinancialGroup_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[FinancialGroup] SET IsActive = 0 WHERE [Id]=@Id;
