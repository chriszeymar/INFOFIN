/****** Object:  StoredProcedure [dbo].[zgen_SpendRequestAttachment_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete SpendRequestAttachment
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_SpendRequestAttachment_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[SpendRequestAttachment] WHERE [Id]=@Id;
