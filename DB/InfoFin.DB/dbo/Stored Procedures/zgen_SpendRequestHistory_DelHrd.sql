/****** Object:  StoredProcedure [dbo].[zgen_SpendRequestHistory_DelHrd] ******/
-- ===================================================================
-- Description    : Hard Delete SpendRequestHistory
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_SpendRequestHistory_DelHrd]
...
BEGIN
  ...
  BEGIN TRY
    ...
    DELETE FROM [dbo].[SpendRequestHistory] WHERE [Id]=@Id;
