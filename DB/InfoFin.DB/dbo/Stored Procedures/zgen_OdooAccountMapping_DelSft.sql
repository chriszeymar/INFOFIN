/****** Object:  StoredProcedure [dbo].[zgen_OdooAccountMapping_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete OdooAccountMapping
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_OdooAccountMapping_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[OdooAccountMapping] SET IsActive = 0 WHERE [Id]=@Id;
