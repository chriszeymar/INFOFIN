/****** Object:  StoredProcedure [dbo].[zgen_BudgetAdjustment_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete BudgetAdjustment
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_BudgetAdjustment_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[BudgetAdjustment] SET IsActive = 0 WHERE [Id]=@Id;
