/****** Object:  StoredProcedure [dbo].[zgen_OdooJournalLine_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete OdooJournalLine
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_OdooJournalLine_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[OdooJournalLine] SET IsActive = 0 WHERE [Id]=@Id;
