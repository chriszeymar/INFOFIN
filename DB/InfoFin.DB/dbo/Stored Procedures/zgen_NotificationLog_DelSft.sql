/****** Object:  StoredProcedure [dbo].[zgen_NotificationLog_DelSft] ******/
-- ===================================================================
-- Description    : Soft Delete NotificationLog
-- ===================================================================

CREATE   PROCEDURE [dbo].[zgen_NotificationLog_DelSft]
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [dbo].[NotificationLog] SET IsActive = 0 WHERE [Id]=@Id;
