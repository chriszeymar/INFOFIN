...
namespace InfoFin.Domain
{
    public partial class SpendRequestService : ISpendRequestService
    {
        ...
        {
            return await _repo.GetSpendRequestByIds(departmentId, categoryId, encoderId, currencyId, assignedToUserId, vendorId, isActive, sortDirection);
        }
        ...
        {
            return await _repo.GetSpendRequestByIdsPaging(departmentId, categoryId, encoderId, currencyId, assignedToUserId, vendorId, isActive, pageNumber, pageSize, sortDirection);
        }
