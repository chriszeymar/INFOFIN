...
namespace InfoFin.Domain
{
    public partial class BudgetService : IBudgetService
    {
        ...
        {
            return await _repo.GetBudgetByIds(departmentId, accountId, currencyId, isActive, sortDirection);
        }
        ...
        {
            return await _repo.GetBudgetByIdsPaging(departmentId, accountId, currencyId, isActive, pageNumber, pageSize, sortDirection);
        }
