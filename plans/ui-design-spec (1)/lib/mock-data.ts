...
> = {
  ...
  pending_director: { label: 'Pending Director', variant: 'default' },
  pending_fpa: { label: 'Pending FP&A', variant: 'warning' },
  pending_md: { label: 'Pending MD', variant: 'purple' },
...
export const spendRequests: SpendRequest[] = [
  {
    ...
    timeline: [
      { step: 'Submitted', actor: 'Dana Whitfield', state: 'done', date: '2026-06-18' },
      { step: 'Director', actor: 'Marcus Lee', state: 'current' },
      { step: 'FP&A', actor: 'Pending', state: 'pending' },
      { step: 'Managing Director', actor: 'Pending', state: 'pending' },
    ],
  },
  {
    id: '2',
    ...
    timeline: [
      { step: 'Submitted', actor: 'Priya Nair', state: 'done', date: '2026-06-17' },
      { step: 'Director', actor: 'Sofia Alvarez', state: 'done', date: '2026-06-18', comment: 'Approved, within budget.' },
      { step: 'FP&A', actor: 'Liam Chen', state: 'current' },
      { step: 'Managing Director', actor: 'Pending', state: 'pending' },
    ],
  },
  {
    ...
    timeline: [
      { step: 'Submitted', actor: 'Tomas Berg', state: 'done', date: '2026-06-15' },
      { step: 'Director', actor: 'Sofia Alvarez', state: 'done', date: '2026-06-16' },
      { step: 'FP&A', actor: 'Liam Chen', state: 'done', date: '2026-06-17', comment: 'Capex confirmed.' },
      { step: 'Managing Director', actor: 'Eleanor Voss', state: 'current' },
    ],
  },
  {
    id: '4',
    ...
    timeline: [
      { step: 'Submitted', actor: 'Hannah Okafor', state: 'done', date: '2026-06-12' },
      { step: 'Director', actor: 'Marcus Lee', state: 'done', date: '2026-06-13' },
      { step: 'FP&A', actor: 'Liam Chen', state: 'done', date: '2026-06-13' },
      { step: 'Managing Director', actor: 'Eleanor Voss', state: 'done', date: '2026-06-14', comment: 'Approved.' },
    ],
  },
  {
    id: '5',
    ...
    timeline: [
      { step: 'Submitted', actor: 'Dana Whitfield', state: 'done', date: '2026-06-10' },
      { step: 'Director', actor: 'Marcus Lee', state: 'done', date: '2026-06-11' },
      { step: 'FP&A', actor: 'Liam Chen', state: 'declined', date: '2026-06-12', comment: 'Exceeds remaining events budget for the quarter.' },
      { step: 'Managing Director', actor: 'Pending', state: 'pending' },
    ],
  },
  {
    ...
    attachments: [],
    timeline: [
      { step: 'Submitted', actor: 'Priya Nair', state: 'current' },
      { step: 'Director', actor: 'Pending', state: 'pending' },
      { step: 'FP&A', actor: 'Pending', state: 'pending' },
      { step: 'Managing Director', actor: 'Pending', state: 'pending' },
    ],
  },
  {
    ...
    timeline: [
      { step: 'Submitted', actor: 'Tomas Berg', state: 'done', date: '2026-06-08' },
      { step: 'Director', actor: 'Sofia Alvarez', state: 'done', date: '2026-06-09' },
      { step: 'FP&A', actor: 'Liam Chen', state: 'done', date: '2026-06-09' },
      { step: 'Managing Director', actor: 'Eleanor Voss', state: 'done', date: '2026-06-10' },
    ],
  },
]
